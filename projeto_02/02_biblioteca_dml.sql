...
VALUES
  ...
  (
    'Ficção Científica',
    'Literatura de ficção científica e fantasia'
  ),
  ('Romance', 'Romances contemporâneos e clássicos'),
  (
    'Tecnologia e Computação',
    'Livros técnicos de programação e TI'
  ),
  ...
  (
    'Referência',
    'Dicionários, enciclopédias e guias'
  );
...
VALUES
  ...
  (
    ...
    '2025-09-05 11:00:00',
    '2025-09-19',
    '2025-09-24 16:00:00', -- CORREÇÃO: Devolvido com 5 dias de atraso (multa de R$ 10,00)
    'Devolvido'
  ),
  (
    4,
  ...
  (
    ...
    '2025-09-15 10:30:00',
    '2025-09-29',
    '2025-10-03 11:00:00', -- CORREÇÃO: Devolvido com 4 dias de atraso (multa de R$ 8,00)
    'Devolvido'
  ),
  (
    8,
  ...
  (
    ...
    '2025-09-25 11:30:00',
    '2025-10-09',
    '2025-10-12 12:00:00', -- CORREÇÃO: Devolvido com 3 dias de atraso (multa de R$ 6,00)
    'Devolvido'
  ),
  (
    16,
...
-- CORREÇÃO: Adicionado campo data_geracao para manter consistência temporal
-- Multas geradas logo após o vencimento do prazo de cada empréstimo
INSERT INTO
  Multas (
    id_emprestimo,
    valor_multa,
...
VALUES
  (26, 62.00, 31, '2025-10-16 10:00:00', 'Pendente', NULL), -- Empréstimo 26: atrasado desde 2025-10-15 (31 dias)
  (27, 54.00, 27, '2025-10-20 10:00:00', 'Pendente', NULL), -- Empréstimo 27: atrasado desde 2025-10-19 (27 dias)
  (28, 48.00, 24, '2025-10-23 10:00:00', 'Pendente', NULL), -- Empréstimo 28: atrasado desde 2025-10-22 (24 dias)
  (29, 44.00, 22, '2025-10-25 10:00:00', 'Pendente', NULL), -- Empréstimo 29: atrasado desde 2025-10-24 (22 dias)
  (30, 40.00, 20, '2025-10-27 10:00:00', 'Pendente', NULL);

-- Empréstimo 30: atrasado desde 2025-10-26 (20 dias)
-- 3 multas para empréstimos devolvidos com atraso (status Pago)
-- CORREÇÃO: Adicionado campo data_geracao para evitar violação da constraint CHK_data_pagamento
-- A constraint exige que: data_pagamento IS NULL OR data_pagamento >= data_geracao
INSERT INTO
  Multas (
    id_emprestimo,
    valor_multa,
...
VALUES
  (2, 10.00, 5, '2025-09-20 10:00:00', 'Pago', '2025-10-05 10:00:00'), -- Multa gerada em set/2025, paga em out/2025
  (5, 8.00, 4, '2025-09-30 10:00:00', 'Pago', '2025-10-10 11:00:00'), -- Multa gerada em set/2025, paga em out/2025
  (9, 6.00, 3, '2025-10-09 10:00:00', 'Pago', '2025-10-15 14:00:00');

-- Devolvido 3 dias após prazo
...
VALUES
  (
    ...
    'Ativa',
    '2025-11-17'
  ), -- Reserva ativa para livro muito procurado
  (
    23,
    15,
    '2025-11-11 11:00:00',
